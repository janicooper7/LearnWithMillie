...
export default async function CoursesPage() {
  ...
  // Purchased courses with progress for the "My Courses" section
    ...
    <div className="min-h-screen bg-[#F4EDE4]">
      ...
      <section className="section-padding" style={{ backgroundColor: '#F4EDE4' }}>
        <div className="container">
          ...
          <CoursePricingCards userAccess={accessedSlugs} />
        </div>
      </section>

      {/* My Courses — only if user has purchased */}
      {myCourses.length > 0 && (
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {myCourses.map(({ course }) => {
                ...
                const completed = course.lessons.reduce((acc, l) => acc + (l.progress.length > 0 ? 1 : 0), 0)
