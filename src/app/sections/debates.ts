// Debate topics dataset for the Debate Generator.
// Split out of DebateGenerator.tsx and loaded via dynamic import() so the
// ~460KB of data is a separate async chunk, not part of the page JS bundle.

export type DebateKeyword = { keyword: string; example: string } | string
export type DebateQuestion = { question: string; keywords: DebateKeyword[] }
const debates = [
  {
    debate_questions: [
      {
...
export const debateQuestions: DebateQuestion[] = debates[0].debate_questions
