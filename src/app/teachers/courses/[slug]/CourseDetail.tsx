  ...
  async function handlePurchase() {
    ...
    try {
      ...
      if (data.url) {
        ...
        // No value: the course record passed to this page doesn't carry
              ...
              <>
                ...
                {!isBundle && (
                  <p className="mt-3 text-sm text-white/65">
                    ...
                    <Link
                      href={`/teachers/courses/${bundleSales.slug}`}
                      className="font-semibold text-[#C2AA6A] underline hover:opacity-90"
                    >
                      See {bundleSales.label}
                    </Link>
                  </p>
                )}
              </>
